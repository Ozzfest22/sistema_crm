                ...
                <div class="card-body">
                    <form method="POST" action="{{route('admin.clients.update', $client->id)}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="contact_name" id="contact_name" class="form-control {{$errors->has('contact_name') ? 'is-invalid' : ''}}" placeholder="Ingrese el nombre del cliente" value="{{old('contact_name', $client->contact_name)}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="contact_email" id="contact_email" class="form-control {{$errors->has('contact_email') ? 'is-invalid' : ''}}" placeholder="Ingrese el email del cliente" value="{{old('contact_email', $client->contact_email)}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="contact_phone_number" id="contact_phone_number" class="form-control {{$errors->has('contact_phone_number') ? 'is-invalid' : ''}}" placeholder="Ingrese el teléfono del cliente" value="{{old('contact_phone_number', $client->contact_phone_number)}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="company_address" id="company_address" class="form-control {{$errors->has('company_address') ? 'is-invalid' : ''}}" placeholder="Ingrese la dirección de la empresa" value="{{old('company_address', $client->company_address)}}">
